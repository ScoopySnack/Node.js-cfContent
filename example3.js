...
const os = require('os'); //os ειναι μια ενσωματωμένη βιβλιοθήκη του node.js που μας δίνει πληροφορίες για το λειτουργικό σύστημα

const osType = os.type();
console.log(osType);

//Το περιεχόμενο της σελίδας που θα επιστραφεί στον client
const htmlContent = `
  <!DOCTYPE html>
  <html>
